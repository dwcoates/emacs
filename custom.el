...
(custom-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#6C6B59"))))
 '(font-lock-string-face ((t (:foreground "#84857E"))))
 ...
 '(mode-line ((t (:box nil :foreground "#44443C" :background "#CFB980"))))
 '(mode-line-buffer-id ((t (:foreground "aquamarine" :weight bold))))
 '(mode-line-inactive ((t (:box nil :background "gray20" :foreground "#CFB980"))))
 ...
 '(region ((t (:foreground "#A9AAA3" :background "#44443C")))))
