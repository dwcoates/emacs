...
(setq basic '(:description "hello, folks!" :location '(id "w293482j-12384985") :scheduling "!!!!!LKJDFI!!!!!!"))
(let ((vv (plist-get basic :todo)))
  (t-wrapper vv "fft" '("sometag" "anothertag") "todo" t nil nil t nil nil nil nil)
  )
...
(defmacro org-make-project-templates (prefix global-tags &rest args)
  ...
  (let ((basic (plist-get args :basic))
    ...
    (append
     (apply
      'cons
      (t-wrapper (plist-get basic :todo) prefix global-tags "todo" t nil nil t nil nil nil) ;; tasks
      (t-wrapper (plist-get basic :idea) prefix global-tags "idea" t nil nil t nil nil nil) ;; idea
      (t-wrapper (plist-get basic :note) prefix global-tags "note" t nil nil t nil nil nil)) ;; note
     (when study
       (apply
        'cons
        (t-wrapper (plist-get study :question) prefix global-tags "question" t "Question" nil nil nil nil nil) ;; question
        (t-wrapper (plist-get study :quick-question) prefix global-tags "question" t "Quick Question" nil nil nil nil nil) ;; quick question
        (t-wrapper (plist-get study :review) prefix global-tags "review" t nil nil t nil nil nil) ;; refresh
        (t-wrapper (plist-get study :learn) prefix global-tags "learn" t nil nil t nil nil nil))) ;; learn
     (when project
       (apply
        'cons
        (t-wrapper (plist-get project :issue) prefix global-tags "issue" t t nil t nil nil nil) ;; issue
        (t-wrapper (plist-get project :bug) prefix global-tags "bug" t t nil t nil nil nil) ;; bug
        (t-wrapper (plist-get project :feature) prefix global-tags "feature" t t nil t nil nil nil)))  ;; feature
     )))
