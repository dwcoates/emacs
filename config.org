#+Title: This is my emacs config file.
* Package Management
...
#+begin_src emacs-lisp
  (defun org-project-template-builder (header tags scheduling body watermark &optional properties)
...
#+begin_src emacs-lisp
    (defun project-tasks-and-todos-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/todo-prompt
                                     org-template--basic-priority
                                     "Task")
                                    (append '("project") tags)
    ...
    (defun project-idea-template (project-name &optional tags watermark properties)
    ...
    (defun project-quick-idea-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/next-prompt
                                     org-template--basic-priority
                                     "Idea")
                                    (append '("project" "idea") (if (listp tags) tags (list tags)))
    ...
    (defun project-quick-note-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/next-prompt
                                     org-template--basic-priority
                                     "Quick Note")
    ...
    (defun project-note-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/next-prompt
                                     org-template--basic-priority
                                     "Note")
                                    (append '("project" "note") (if (listp tags) tags (list tags)))
    ...
    (defun project-question-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/next-prompt
                                     org-template--basic-priority
                                     "Question")
    ...
    (defun project-quick-question-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/next-prompt
                                     org-template--basic-priority
                                     "Question")
                                    (append '("project" "question") (if (listp tags) tags (list tags)))
    ...
    (defun project-issue-template (project-name &optional tags watermark properties)
      (org-project-template-builder (org-template/next-prompt
                                     org-template--basic-priority
                                     "Issue")
    ...
    (defun project-bug-template (project-name &optional tags watermark properties)
    ...
    (defun project-feature-template (project-name &optional tags watermark properties)
...
#+begin_src emacs-lisp
  (defun emacs-idea-template (&optional tags watermark properties)
    (project-idea-template "Emacs" tags watermark properties))

  (defun emacs-task-template (&optional tags watermark properties)
    (project-tasks-and-todos-template "Emacs" tags watermark properties))

  (defun emacs-task-template (&optional tags watermark properties)
    (project-tasks-and-todos-template "Emacs" tags watermark properties))

  (defun emacs-tip-template (&optional tags watermark properties)
    (project-idea-template "Emacs" (append '("tip") tags) watermark properties))

  (defun emacs-quick-tip-template (&optional tags watermark properties)
    (project-quick-idea-template "Emacs" (append '("tip") tags) watermark properties))

  (defun emacs-question-template (&optional tags watermark properties)
    (project-question-template "Emacs" tags watermark properties))

  (defun emacs-quick-question-template (&optional tags watermark properties)
    (project-quick-question-template "Emacs" tags watermark properties))

  (defun emacs-note-template (&optional tags watermark properties)
    (project-note-template "Emacs" tags watermark properties))

  (defun emacs-quick-note-template (&optional tags watermark properties)
    (project-quick-note-template "Emacs" tags watermark properties))

  (defun emacs-feature-template (&optional tags watermark properties)
    (project-feature-template "Emacs" tags watermark properties))

  (defun emacs-issue-template (&optional tags watermark properties)
    (project-issue-template "Emacs" tags watermark properties))

  (defun emacs-bug-template (&optional tags watermark properties)
    (project-bug-template "Emacs" tags watermark properties))
#+end_src
