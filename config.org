...
#+begin_src emacs-lisp
    ...
    (defconst org-basic-task-template
      (org-project-template-builder (org-template/todo-prompt
                                    ...
                                    org-indented-cursor-placement
                                    org-template/meta-data))
    (defconst org-basic-oh-yeah-template
