...
#+BEGIN_SRC emacs-lisp
  (use-package smartparens
    :config
    (sp-pair "'" nil :when '(not (eq major-mode 'lisp-mode)) :actions nil) 
...
point.
#+begin_src emacs-lisp
  (add-to-list 'load-path (concat user-emacs-directory "goodies"))
...
#+begin_src emacs-lisp
  (setq org-deadline-warning-days 2 
        org-default-notes-file "~/personal/todo.org"
...
#+begin_src emacs-lisp
  (add-to-list 'load-path (concat user-emacs-directory "org-misc"))
...
#+begin_src emacs-lisp
    ...
    (defconst org-indented-cursor-placement "  %?")
      ;;;;;; WATERMARK ;;;;;;;
    (defconst org-template/meta-data "Captured on %T by %(system-name)")
#+end_src
...
***** Templates
Basic, non-descript templates.
#+begin_src emacs-lisp
  (defconst org-basic-idea-template (project-idea-template))
  (defconst org-basic-note-template (project-note-template))
  (defconst org-basic-quick-note-template (project-quick-note-template))
  (defconst org-basic-question-template (project-question-template))
  (defconst org-basic-task-template (project-tasks-and-todos-template))
#+end_src

emplates for emacs-related captures.
#+begin_src emacs-lisp
(defconst emacs-idea-template (project-idea-template "emacs"))
(defconst emacs-task-template (project-tasks-and-todos-template "emacs"))
(defconst emacs-question-template (project-question-template "emacs"))
(defconst emacs-quick-question-template (project-quick-question-template "emacs"))
(defconst emacs-note-template (project-note-template "emacs"))
(defconst emacs-quick-note-template (project-quick-note-template "emacs"))

(defconst emacs-feature-template (project-note-template "emacs" "feature"))
(defconst emacs-issue-template (project-note-template "emacs" "issue"))
(defconst emacs-bug-template (project-note-template "emacs" "bug"))
#+end_src
...
#+begin_src emacs-lisp
  (defconst org-basic-idea-template       (project-idea-template))
  (defconst org-basic-quick-idea-template (project-quick-idea-template))
  (defconst org-basic-note-template       (project-note-template))
  (defconst org-basic-quick-note-template (project-quick-note-template))
  (defconst org-basic-question-template   (project-question-template))
  (defconst org-basic-task-template       (project-tasks-and-todos-template))
  (defconst org-basic-nugget-template     (org-project-template-builder
...
#+begin_src emacs-lisp
  (defconst emacs-idea-template       (project-idea-template "emacs"))
  (defconst emacs-quick-idea-template (project-quick-idea-template"emacs"))

  (defconst emacs-feature-template       (project-idea-template "emacs" "feature"))
  (defconst emacs-quick-feature-template (project-quick-idea-template"emacs" "feature"))

  (defconst emacs-bug-template       (project-idea-template "emacs"))
  (defconst emacs-quick-bug-template (project-quick-idea-template"emacs"))
