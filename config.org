...
#+begin_src emacs-lisp
  ...
  (defun project-issue-template (project-name &optional tags watermark properties)
    (org-project-template-builder (org-template/next-prompt nil "Issue")
  ...
  (defun project-bug-template (project-name &optional tags watermark properties)
    (org-project-template-builder (org-template/next-prompt nil "Bug")
  ...
  (defun project-feature-template (project-name &optional tags watermark properties)
    (org-project-template-builder (org-template/next-prompt nil "Feature")
