...
#+begin_src emacs-lisp
(define-key isearch-mode-map (kbd "C-w") 'isearch-repeat-forward)
(define-key isearch-mode-map (kbd "C-S-w") 'isearch-repeat-backward)
   #+end_src
...
#+begin_src emacs-lisp
  ...
  ;;               a   s   d   f   h   j   l  ;
  (setq avy-keys '(97 115 100 102 106 108 104 59))
