...
#+begin_src emacs-lisp
  ...
  (define-key org-agenda-mode-map (kbd "C-c k") 'org-agenda-kill-entries)
...
(defconst emacs-feature-template (project-feature-template "emacs"))
(defconst emacs-issue-template (project-issue-template "emacs"))
(defconst emacs-bug-template (project-bug-template "emacs"))
#+end_src
