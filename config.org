...
#+begin_src emacs-lisp
  ...
  (defmacro get-personal-file-binding (file key)
    (make-get-personal-file-key (file-truename (directory-file-name
                                ...
                                key))
#+end_src
** disable helm modeline (possibly uselss)

This code was useful before, but now doom makes helm come from minibuffer. Idk.
...
These have to be fetched with doom's method

#+begin_src emacs-lisp
  (add-to-list 'load-path (concat doom-lisp-dir "goodies"))  ;; personal goodies
  (add-to-list 'load-path (concat doom-lisp-dir "org-misc")) ;; org-misc functions
#+end_src
* Org
** agenda
...
#+begin_src emacs-lisp
  (add-to-list 'load-path (concat doom-lisp-dir "goodies"))
...
** General
#+begin_src emacs-lisp
  (add-to-list 'load-path (concat doom-lisp-dir "org-notes"))
  (require 'org-notes)
...
#+begin_src emacs-lisp
#+begin_src emacs-lisp
(add-to-list 'load-path (concat doom-lisp-dir "yas-org-pretty-symbols"))
...
#+begin_src emacs-lisp
  (add-to-list 'load-path (concat doom-lisp-dir "atchka-org"))
  (add-to-list 'load-path (concat doom-lisp-dir "atchka-org-blocks"))
...
#+begin_src emacs-lisp
  (add-to-list 'load-path (concat doom-lisp-dir "org-capture-builder"))
...
#+BEGIN_SRC emacs-lisp
;; Edit With Emacs (Google Chrome Extension)
(add-to-list 'load-path (concat doom-lisp-dir "edit-with-emacs"))
