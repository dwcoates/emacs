...
** General
   :PROPERTIES:
   :ID:       b5eac278-7f1d-4579-bce0-d371673803e7
   :END:
   :LINKS:
   :>: [[id:c7ccb4d6-2f20-4423-affb-0e3045d2d4fc][Comparison of Logistic Regression and LDA: A simulation study]]
   :END:
...
(setcdr (assoc 'state org-log-note-headings) "State changed to %-12s from %-12S %T")
#+end_src
...
#+begin_src emacs-lisp
  (setq org-todo-keywords
        (quote ((sequence "TODO(t)" "IDEA(e) ""NEXT(n)" "|" "DONE(d)")
                (sequence "LEARN(l)" "REVIEW(r)" "QUIZ(z)" "|" "NOTE(o)" "CLARIFY(c)" )
  ...
  (setq org-todo-keyword-faces
        (quote (("TODO" :foreground "#cd2626" :weight bold)
                ...
                ("IDEA" :foreground "#ff8c00" :weight bold)
