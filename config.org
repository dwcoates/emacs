...
#+begin_src emacs-lisp
    (defhydra hydra-windows (:hint none)
      "
  ...
  H Adjust: _zs_hrink _ze_nlarge
  V Adjust: _vs_shrink _ve_nlarge"
      ("vs"  shrink-window)                 ; vertical
      ("ve"  enlarge-window)                ; vertical
      ("zs"  shrink-window-horizontally)
      ("ze"  enlarge-window-horizontally)
      ;; windmove
      ("h" windmove-left)
      ("j" windmove-down)
      ("k" windmove-up)
...
(global-set-key (kbd "C-S-o") 'hydra-windows/body)
#+end_src
