...
;    (setq-default py-shell-name "jupyter")
    ...
    ;(setq python-shell-interpreter "~/.local/anaconda2/bin/jupyter-console"
...
*** Agenda
#+begin_src emacs-lisp
  (setq org-agenda-files '("~/personal/everything.org")
...
#+begin_src emacs-lisp
  ...
  (defvar basic-nugget-template "* %^{Thought:}       :idea:
