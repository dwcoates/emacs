...
#+begin_src emacs-lisp
  (defun  org-frame () 
    ...
    (defun leven-frames ()
      (find-file "~/workspace/leven-squash/levenshtein/compression.py")
      (split-window-horizontally)
      (windmove-right)
      (find-file "~/workspace/leven-squash/tests/compression_tests.py")
      (split-window-below)
      (windmove-down)
      (eshell)

      (find-file-other-frame "~/workspace/leven-squash/project.org")
      (toggle-frame-fullscreen)
      (split-window-horizontally)
      (windmove-right)
      ;; insert a new pythong shell, i guess
      )
