...
#+begin_src emacs-lisp
  (add-hook 'prog-mode-hook (lambda () (interactive)
                              ...
                              (linum-mode t) ; use linum, not nlinum
                              ))
#+end_src
...
see [[http://emacs.stackexchange.com/questions/24750/emacs-freezes-with-ipython-5-0-0][here]] for info on IPython5 not working properly in Emacs.
...
#+begin_src emacs-lisp
  (use-package ein
    ...
    (defun switch-color ()
      ...
      (face-remap-add-relative 'default '((:background "gray20"))))
