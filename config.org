...
#+begin_src emacs-lisp
  (defun helm-mode-line-hook ()
    (let ((color "#8b475d"))
      ...
      (face-remap-add-relative
       'helm-candidate-number `((:foreground ,color :background ,color) mode-line))
      (face-remap-set-base 'mode-line-buffer-id '(:foreground "black"))))
...
#+begin_src emacs-lisp
  ...
  (setq-default py-shell-interpreter "ipython")
...
#+BEGIN_SRC emacs-lisp
    (use-package elpy
      ...
      (add-hook 'elpy-mode-hook 'flycheck-mode 'elpy-use-ipython)
      (elpy-use-ipython)
...
#+begin_src emacs-lisp
  ...
  (defun org-basic-note-template (&optional tags watermark properties)
    (org-project-template-builder "* NOTE %^{Note}"
...
#+begin_src emacs-lisp
  ...
  (defun project-question-template (project-name &optional tags watermark properties more-tags)
    (org-project-template-builder "* LEARN %^{Learn}"
  ...
  (defun project-issue-template (project-name &optional tags watermark properties more-tags)
    (org-project-template-builder "* ISSUE %^{Issue}"
  ...
  (defun project-bug-template (project-name &optional tags watermark properties more-tags)
    (org-project-template-builder "* BUG %^{Bug}"
  ...
  (defun project-feature-template (project-name &optional tags watermark properties more-tags)
    (org-project-template-builder "* FEATURE %^{Feature}"
...
** Calculator
   ...
   Emacs calculator is very cool once you get used to it.
